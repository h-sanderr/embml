...
#ifndef AI_COOLER_NN_H
#define AI_COOLER_NN_H
#pragma once
...
/******************************************************************************/
#define AI_COOLER_NN_MODEL_NAME          "cooler_nn"
#define AI_COOLER_NN_ORIGIN_MODEL_NAME   "model_cooler"

/******************************************************************************/
#define AI_COOLER_NN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_COOLER_NN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_COOLER_NN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_COOLER_NN_IN_NUM        (1)

AI_DEPRECATED
#define AI_COOLER_NN_IN \
  ai_cooler_nn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_COOLER_NN_IN_SIZE { \
  AI_COOLER_NN_IN_1_SIZE, \
}
#define AI_COOLER_NN_IN_SIZE_BYTES { \
  AI_COOLER_NN_IN_1_SIZE_BYTES, \
}
#define AI_COOLER_NN_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_COOLER_NN_IN_1_CHANNEL     (384)
#define AI_COOLER_NN_IN_1_SIZE        (384)
#define AI_COOLER_NN_IN_1_SIZE_BYTES  (1536)

/******************************************************************************/
#define AI_COOLER_NN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_COOLER_NN_OUT \
  ai_cooler_nn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_COOLER_NN_OUT_SIZE { \
  AI_COOLER_NN_OUT_1_SIZE, \
}
#define AI_COOLER_NN_OUT_SIZE_BYTES { \
  AI_COOLER_NN_OUT_1_SIZE_BYTES, \
}
#define AI_COOLER_NN_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_COOLER_NN_OUT_1_CHANNEL     (2)
#define AI_COOLER_NN_OUT_1_SIZE        (2)
#define AI_COOLER_NN_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_COOLER_NN_N_NODES (4)
 ...
 * @ref ai_cooler_nn_create. Both the activations memory buffer 
 ...
 * using @ref ai_cooler_nn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cooler_nn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cooler_nn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_COOLER_NN_*
 * defines into file @ref cooler_nn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_cooler_nn_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_COOLER_NN_H */
