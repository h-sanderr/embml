...
/******************************************************************************/
#define AI_COOLER_MODEL_NAME          "cooler"
#define AI_COOLER_ORIGIN_MODEL_NAME   "cooler"

/******************************************************************************/
#define AI_COOLER_ACTIVATIONS_ALIGNMENT   (4)
#define AI_COOLER_INPUTS_IN_ACTIVATIONS   (4)
#define AI_COOLER_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_COOLER_IN_NUM        (1)

AI_DEPRECATED
#define AI_COOLER_IN \
  ai_cooler_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_COOLER_IN_SIZE { \
  AI_COOLER_IN_1_SIZE, \
}
#define AI_COOLER_IN_SIZE_BYTES { \
  AI_COOLER_IN_1_SIZE_BYTES, \
}
#define AI_COOLER_IN_1_FORMAT      AI_BUFFER_FORMAT_S16
#define AI_COOLER_IN_1_CHANNEL     (768)
#define AI_COOLER_IN_1_SIZE        (768)
#define AI_COOLER_IN_1_SIZE_BYTES  (1536)

/******************************************************************************/
#define AI_COOLER_OUT_NUM       (1)

AI_DEPRECATED
#define AI_COOLER_OUT \
  ai_cooler_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_COOLER_OUT_SIZE { \
  AI_COOLER_OUT_1_SIZE, \
}
#define AI_COOLER_OUT_SIZE_BYTES { \
  AI_COOLER_OUT_1_SIZE_BYTES, \
}
#define AI_COOLER_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_COOLER_OUT_1_CHANNEL     (2)
#define AI_COOLER_OUT_1_SIZE        (2)
#define AI_COOLER_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_COOLER_N_NODES (5)
 ...
 * @ref ai_cooler_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cooler_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cooler_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_COOLER_*
 * defines into file @ref cooler.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
